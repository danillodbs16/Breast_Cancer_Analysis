...
def update_probability(n, *inputs):
    ...
    return html.Div([
        html.P(f"Benign: {B*100:.1f}%"),
        html.P(f"Malignant: {M*100:.1f}%")
    ])
...
def update_3d(mode, x, y, z, n_neighbors, metric):
    ...
    fig.update_layout(height=650, margin=dict(l=0, r=0, b=0, t=40))
